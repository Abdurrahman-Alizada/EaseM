    ...
    <div class="flex max-w-sm mx-auto overflow-hidden bg-gray-200 mt-10 shadow-2xl rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
        <div class="hidden bg-cover bg-center w-9 lg:block lg:w-1/2" :style="{ backgroundImage: `url(${BU})` }"></div>
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <span  class="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">or</span>
...
<script>
import BI from '@/assets/svgs/1.svg'
export default{
    data(){
        return{
            BU : BI,
